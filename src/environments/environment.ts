...
export const environment = {
  ...
  storageBucket: "charkashopping.firebasestorage.app",
...
//export function firebaseConfig(firebaseConfig: any): any[] | import("@angular/core").Type<any> | import("@angular/core").ModuleWithProviders<{}> {
